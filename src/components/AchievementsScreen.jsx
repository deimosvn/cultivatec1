...
const ACHIEVEMENTS = [
  ...
  { id: 'first_challenge', title: 'Retador', description: 'Completa tu primer Reto', icon: '🧩', category: 'Retos', points: 10, condition: (s) => s.challengesCompleted >= 1, rarity: 'común' },
  { id: 'all_challenges', title: 'Maestro de Retos', description: 'Completa todos los Retos', icon: '🏆', category: 'Retos', points: 40, condition: (s) => s.challengesCompleted >= 2, rarity: 'épico' },
