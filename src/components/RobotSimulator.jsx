...
const DraggablePart = ({ part, index, onRemove }) => {
  return (
    ...
    >
      <div className="w-[68px] h-[68px] bg-white rounded-xl border-2 border-dashed border-[#E5E5E5] flex items-center justify-center hover:border-[#60A5FA] transition cursor-grab active:cursor-grabbing">
...
const CatalogPart = ({ part, onAdd }) => (
  <div
    ...
    onClick={() => onAdd(part)}
    className="flex flex-col items-center p-2 bg-white rounded-xl border border-gray-200 cursor-grab active:cursor-grabbing hover:border-blue-400 hover:shadow-md transition active:scale-95 group"
  >
...
const ChassisAssemblyView = ({ template, workspace, slotAssignments, onSlotDrop, onSlotRemove }) => {
  ...
  const typeColors = {
    ...
    free: { bg: 'from-blue-900 to-indigo-950', accent: '#8B5CF6', grid: 'rgba(139,92,246,0.06)' },
  };
              ...
              <div onClick={() => setPhase('axon_merge')}
                ...
                <div className="flex items-center gap-4 relative z-10">
                  ...
                  <div className="flex-grow min-w-0">
                    ...
                    <p className="text-xs text-blue-300/70 mt-0.5">Fusiona componentes y construye un robot</p>
                  </div>
              ...
              <div onClick={() => setPhase('sumo_push')}
                ...
                <div className="flex items-center gap-4 relative z-10">
                  ...
                  <div className="flex-grow min-w-0">
                    ...
                    <p className="text-xs text-blue-300/70 mt-0.5">Pelea de robots sumo para 2 jugadores</p>
                  </div>
                  <div className="flex-shrink-0">
                  ...
                  <div key={t.id} onClick={() => pickTemplate(t)}
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                      ...
                      <div className="flex-grow min-w-0">
                        ...
                        <p className="text-xs text-blue-300/70 mt-0.5">{t.desc}</p>
                      </div>
                      <div className="flex-shrink-0">
    ...
    return (
      <div className="min-h-full galaxy-bg animate-fade-in flex flex-col relative">
        ...
        <div className="relative z-10 bg-gradient-to-b from-[#0F1A3E]/95 to-[#1E1B4B]/90 px-5 pt-4 pb-5 border-b border-blue-500/30">
          ...
          <p className="text-blue-300/80 text-xs font-bold text-center mt-1">
          ...
          <button 
            ...
            className={`flex-1 py-2.5 rounded-xl text-xs font-black transition border ${
              showMaterials && !showCode 
                ? 'bg-blue-500/30 text-white border-blue-400/50 shadow-lg shadow-blue-500/10' 
          ...
          {showMaterials && !showCode && (
            <div className="space-y-4 animate-fade-in">
              <div className="station-panel p-4">
                ...
                <p className="text-sm text-blue-300/70 mb-4">{instructions?.intro}</p>
                
                <div className="space-y-3">
                  {instructions?.materials?.map((mat, i) => (
                    <div key={i} className="flex items-start gap-3 p-3 bg-blue-500/10 border border-blue-400/20 rounded-xl">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-xs text-blue-300/60 mt-0.5">{mat.desc}</p>
                        {mat.buyTip && (
              ...
              <div className="station-panel p-4">
                ...
                <div className="space-y-2">
                  {instructions?.tips?.map((tip, i) => (
                    <p key={i} className="text-xs text-blue-300/70">{tip}</p>
                  ))}
                </div>
              </div>
            </div>
                ...
                <button
                  ...
                  className={`flex-1 py-3 rounded-xl font-black text-sm flex items-center justify-center gap-1 transition border ${
                    currentStep >= steps.length - 1
                      ? 'bg-white/5 text-blue-400/30 border-white/5' 
                      : 'bg-blue-500/30 text-white border-blue-400/50 active:scale-95 shadow-lg shadow-blue-500/20'
                  }`}
                >
                ...
                <div className="space-y-2 relative z-10">
                  {steps.map((step, i) => (
                    ...
                    >
                      ...
                      <span className={`text-sm font-bold ${currentStep === i ? 'text-white' : 'text-blue-300/70'}`}>
                        {step.title}
                      </span>
                    </button>
                  ))}
            ...
            <div className="animate-fade-in">
              <div className="station-panel p-4 overflow-hidden">
                <div className="flex items-center gap-2 mb-3 relative z-10">
                  ...
                  <span className="ml-auto text-xs text-blue-400/60 font-mono">Arduino IDE</span>
                </div>
            ...
            <button key={tab.id}
              ...
              className={`flex-1 py-2 rounded-xl text-[10px] font-black transition active:scale-95
                ${phase === tab.id 
                  ...
                  : 'bg-white/5 text-blue-300/70 border border-white/5 hover:bg-white/10'}`}>
              {tab.label}
            </button>
          ))}
        </div>
              ...
              <div className="space-y-3">
                ...
                {uploadProgress >= 100 && (
                  <button onClick={resetUpload}
                    className="w-full py-3 bg-white/5 border border-blue-400/20 text-blue-300 text-sm font-bold rounded-xl hover:bg-white/10 transition active:scale-[0.97] flex items-center justify-center gap-1.5">
