                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flex: 1, minWidth: 0 }}>
                        {userProfile && RobotMini && (
                            <button onClick={onEditRobot} style={{
                                ...
                                borderRadius: 0, padding: '4px', cursor: 'pointer', flexShrink: 0,
                                boxShadow: '0 0 8px rgba(59,130,246,0.2), inset 0 0 0 1px #0a1628',
                            }}>
                                <RobotMini config={userProfile.robotConfig} size={38} />
                            </button>
                        )}
                        <div style={{ minWidth: 0, flex: 1 }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                                <span style={{
                                    fontSize: '10px', fontWeight: 900, color: '#e2e8f0',
                                    fontFamily: PF,
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '5px', marginTop: '4px' }}>
                                <span style={{ fontSize: '7px', fontWeight: 900, color: '#22c55e', fontFamily: PF }}>
                                    NV.{levelInfo.level}
                                </span>
                                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
                        <div style={{
                            ...
                            <Zap size={13} style={{ color: '#fbbf24', filter: 'drop-shadow(0 0 2px #fbbf2460)' }} />
                            <span style={{ fontSize: '9px', fontWeight: 900, color: '#fbbf24', fontFamily: PF, textShadow: '0 0 4px #fbbf2440' }}>
                        ...
                        <div style={{
                            ...
                            <Star size={13} style={{ color: '#facc15', filter: 'drop-shadow(0 0 2px #facc1560)' }} />
                            <span style={{ fontSize: '9px', fontWeight: 900, color: '#facc15', fontFamily: PF, textShadow: '0 0 4px #facc1540' }}>
                                {(firebaseProfile?.totalPoints ?? userStats?.totalPoints ?? 0).toLocaleString()}
                            </span>
                        </div>
                        {onShowLicenses && (
                            <button onClick={onShowLicenses} style={{
                                padding: '6px', background: 'rgba(15,26,50,0.7)',
